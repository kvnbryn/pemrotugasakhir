...
<head>
    ...
    <style>
        ...
        .result-container .level-name {
            font-size: 1.1rem;
            color: #28a745;
            margin-bottom: 20px;
        }
        .score-display { /* Total Poin yang didapat */
            font-size: 2.8rem; /* Lebih kecil dari IQ simulasi */
            font-weight: bold;
            color: #0056b3;
            margin: 10px 0;
        }
         .simulated-iq-display { /* Untuk Skor IQ Simulasi */
            font-size: 3.8rem;
            font-weight: bold;
            color: #dc3545; /* Warna berbeda untuk menekankan ini simulasi */
            margin: 15px auto;
            padding: 15px;
        ...
        .simulated-iq-display span { font-size: 0.4em; display:block; line-height:1; color: #721c24; margin-top:-10px;}
